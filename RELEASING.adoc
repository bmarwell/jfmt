...
The release process has been redesigned into three phases:
...
The maven-release-plugin is configured in the root `pom.xml`:
...
Note: The `deploy` goal is configured, but actual deployment is skipped via:
