...
/**
 * Simplified test to verify that static imports are placed first when using
 * the default import order configuration. Uses the existing test infrastructure.
 */
class AbstractCommandLikeImportOrderTest extends ImportOrderProcessorTestBase {
